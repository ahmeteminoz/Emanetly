...
class UserProfile {
  ...
  factory UserProfile.fromMap(Map<String, dynamic> map) {
    return UserProfile(
      ...
      successfulBorrows: (map['successfulBorrows'] as num?)?.toInt() ?? 0,
      successfulLends: (map['successfulLends'] as num?)?.toInt() ?? 0,
      onTimeReturnRate: (map['onTimeReturnRate'] as num?)?.toDouble() ?? 100.0,
      avgResponseTime: map['avgResponseTime']?.toString() ?? '',
      lateReturnsCount: (map['lateReturnsCount'] as num?)?.toInt() ?? 0,
