...
class ActiveTransactionsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Filter requests under pre-agreement chat discussion
    final discussionRequests = appState.borrowRequests.where((req) {
    ...
    final isEmpty = activeItems.isEmpty && discussionRequests.isEmpty;
